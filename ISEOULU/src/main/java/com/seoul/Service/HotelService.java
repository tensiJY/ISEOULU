...
public class HotelService {
	...
	public HashMap getList(HotelVO vo){
		...
		ArrayList rList = hdao.getRoundList(map); //	다음	맵 오른쪽(2Km 반경 데이터-호텔,음식점,관광지)
		ArrayList tList = hdao.getTravlList(map); //	다음	관광(32, 39 이외의 좌표 정보)
		ArrayList hList = hdao.getHotelList2(map);//	다음	숙박(32, 좌표정보들) 
		ArrayList fList = hdao.getFooodList(map);//		다음	음식(39, 좌표정보들)
